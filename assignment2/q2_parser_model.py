...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 25 12:23:21 2019
...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        with tf.variable_scope("transformation"):
            ...
            W = xavier_initializer(shape = (Config().n_features * Config().embed_size, Config().hidden_size))
            U = xavier_initializer(shape = (Config().hidden_size, Config().n_classes))
